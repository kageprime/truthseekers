...
export default function InteractiveTimeline({ events }: { events: TimelineEvent[] }) {
  ...
  return (
    <div className="pixel-card p-6 my-4" style={{ background: "var(--ice)" }}>
        ...
        {(() => {
          ...
          return sorted
            ...
            return (
              <div
                key={ev.year}
                className="absolute top-1/2 -translate-x-1/2 -translate-y-1/2 border-2 border-black rounded-full cursor-pointer transition-all duration-150"
                style={{
                  left: `${x}%`,
      ...
      {/* Year labels — collision-free: stagger overlapping labels, show active */}
      ...
      {activeIdx !== null && (
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            <span className="pixel text-lg font-bold" style={{ color: "var(--blue)" }}>
