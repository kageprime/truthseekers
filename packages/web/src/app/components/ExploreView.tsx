  ...
  return (
    <div className="fixed inset-0 flex flex-col animate-fade-in bg-surface" style={{ zIndex: "var(--z-explore-press)" }}>
      ...
      <div className="shrink-0 flex items-center justify-between px-4 h-12 border-b border-rule bg-surface">
        <button
          onClick={close}
          className="inline-flex items-center gap-1.5 text-xs font-medium dateline hover:underline text-gold"
        >
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto">
        <article className="max-w-[42rem] mx-auto px-6 py-12 sm:py-16">
          {/* Title */}
          <h1 className="t-display text-3xl sm:text-4xl leading-tight mb-6 text-ink">
            {article.title}
          </h1>
          <div className="mb-8 h-[2px] w-14 bg-gold" />
