...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-4" style={{ background: "var(--warm)" }}>
        ...
        {sent ? (
          ...
          <>
            ...
            <button
              ...
              className="w-full mb-4 pixel text-[8px] py-2 border-2 border-dashed border-[var(--ink)] transition-all hover:bg-white"
