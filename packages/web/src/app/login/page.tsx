    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4" style={{ background: "var(--warm)" }}>
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm mt-2" style={{ color: "#5f6368" }}>Sign in to Truthseekers</p>
        </div>
        ...
        {sent ? (
          <div className="text-center p-8 rounded-2xl border-2 border-black" style={{ background: "white", boxShadow: "6px 6px 0px var(--ink)" }}>
            ...
            <button onClick={() => setSent(false)} className="mt-6 pixel text-[9px] px-4 py-3 min-h-[44px] border-2 border-black" style={{ background: "white", color: "var(--ink)" }}>
          ...
          <>
            ...
            <div className="space-y-2 mb-6">
              <button onClick={() => handleOAuth("github")} className="w-full flex items-center justify-center gap-3 px-4 py-3 min-h-[44px] border-2 border-black rounded-xl text-sm font-medium" style={{ background: "#24292e", color: "white", boxShadow: "4px 4px 0px var(--ink)" }}>
              ...
              <button onClick={() => handleOAuth("google")} className="w-full flex items-center justify-center gap-3 px-4 py-3 min-h-[44px] border-2 border-black rounded-xl text-sm font-medium" style={{ background: "white", color: "var(--ink)", boxShadow: "4px 4px 0px var(--ink)" }}>
